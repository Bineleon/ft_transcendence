 ...
 */
export function userController(app, userService) {
    /**
     * GET /api/users/me
     ...
     * }
     */
    app.get('/api/users/me', { preHandler: authenticate }, async (request) => {
     ...
     * }
     */
    app.put('/api/users/:id', { preHandler: [authenticate, requireOwner] }, async (request) => {
        const userId = request.params.id;
     ...
     * }
     */
    app.put('/api/users/:id/password', { preHandler: [authenticate, requireOwner] }, async (request) => {
        const userId = request.params.id;
     ...
     * }
     */
    app.delete('/api/users/:id', { preHandler: [authenticate, requireOwner] }, async (request, reply) => {
        const userId = request.params.id;
